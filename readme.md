...
| Colab | Info
| --- | --- |
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/moontasirabtahee/Fooocus/blob/main/fooocus_colab.ipynb) | Fooocus (Realistic Preset with LUSTIFY-v2.0 Default)

In Colab, the notebook is configured to clone this repository and run with `--preset realistic` by default (uses LUSTIFY-v2.0 model). You can edit the last line of the cell if you want other presets: `!python entry_with_update.py --share --always-high-vram` or `!python entry_with_update.py --share --always-high-vram --preset anime`.
