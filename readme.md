...
In Colab, the notebook is configured to clone this repository and run with `--preset realistic` by default. You can edit the last line of the cell if you want to run with other presets, for example: `!python entry_with_update.py --share --always-high-vram` or `!python entry_with_update.py --share --always-high-vram --preset anime`.
